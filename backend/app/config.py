...
class Settings(BaseSettings):
    ...
    OCR_UPLOAD_URL: str = "http://172.16.12.215:8000/api/v1/ocr/upload-image"
    OCR_SCAN_URL: str = "http://172.16.12.215:8000/api/v1/ocr/scan-url"
    OCR_WEBSOCKET_URL: str = "ws://172.16.12.215:8000/api/v1/ocr/ws/verify"
